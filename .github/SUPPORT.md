# Getting help with transfer

Thanks for using transfer. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/transfer/issues) to make sure the 
